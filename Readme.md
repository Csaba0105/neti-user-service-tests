...
# Klónozd a repository-t (a linket a kapcsolattartódtól kapod meg)
git clone <link_a_user_service_projekthez>
...
Új felhasználó létrehozása. A request body-ban egy User objektumot vár (ID nélkül).
...
Meglévő felhasználó adatainak frissítése. A request body-ban egy teljes User objektumot vár.
...
3. Leadás és Értékelés
   Leadás
   Hozd létre a teszt-projektet egy új, publikus GitHub repository-ban.

Győződj meg róla, hogy a README.md fájl teljes és informatív.

A repository linkjét küldd el annak a személynek, akivel a kapcsolatot tartod.
...
Tesztesetek Lefedettsége

Mennyire alaposan fedted le a pozitív, negatív és határeseti forgatókönyveket az API tesztelés során?

30%

Kódstruktúra és Tisztaság

Olvasható, logikusan felépített, karbantartható kód. Megfelelő osztály- és mappastruktúra.

20%

CI/CD Futtathatóság

A tesztek parancssorból (mvn test) futtathatóak-e? Bónusz pont a .gitlab-ci.yml fájlért.

15%

Design Pattern Alkalmazása

Használtál-e releváns design pattern-eket (pl. Builder, Factory, Page Object Model)?

15%

Hibakezelés és Assertálás

Hogyan kezeled a hibákat? Az assertek egyértelműek, célratörőek és hasznos visszajelzést adnak hiba esetén?

10%

Dokumentáció

A README.md minősége, teljessége és érthetősége.
